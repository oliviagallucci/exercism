...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    #actual exchange rate after applying spread
    actual_exchange_rate = exchange_rate * (1 + spread_decimal)
    
    # convert budget to currency with actual exchange rate
    exchanged_value = budget / actual_exchange_rate
    
    # maximum amount that can be exchanged in whole denomination
    exchangeable_amount = int(exchanged_value // denomination) * denomination
